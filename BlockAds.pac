...
function FindProxyForURL(url, host) {
    ...
    // Block for a specific domain (instrumenttactics.com)
    if (shExpMatch(host, "instrumenttactics.com") || shExpMatch(host, "*.instrumenttactics.com")) {
        return "PROXY 127.0.0.1";
    }
    ...
    // If no ads are matched, connect directly
    return "DIRECT";
}
